...
def get_cell_forces(points, beta=5, S=1):
    ...
    for i, point1 in enumerate(points):
        ...
        neighbours = get_nearest_neighbours(vor.ridge_points, i, points)
        for index in neighbours:            # Gets the neighbours index for the specific cell                  # For every neighbour belonging to that cell                                     # Not counting the interaction of the cell on itself (even though its zero)
